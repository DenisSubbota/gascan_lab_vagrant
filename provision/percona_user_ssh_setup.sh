...
if [ -f /vagrant/config/monitor_id_rsa.pub ]; then
    sudo -u percona mkdir -p /home/percona/.ssh
    cat /vagrant/config/monitor_id_rsa.pub | sudo tee -a /home/percona/.ssh/authorized_keys > /dev/null
...
sudo cp /vagrant/config/.vagrant_profile /home/vagrant/.profile
